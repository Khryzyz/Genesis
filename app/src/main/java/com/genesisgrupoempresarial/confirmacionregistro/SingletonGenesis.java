...
public final class SingletonGenesis {

    private static SingletonGenesis singletonGenesis;
     ...
     * @param context
     */
    private SingletonGenesis(Context context) {

        //Se ingresa el contexto de la aplicacion del valor contexto enviado al constructor
        SingletonGenesis.contextoAplicacion = context;
     ...
     * @return
     */
    public static synchronized SingletonGenesis getInstance(Context context) {

        //Si la instancia No esta creada la crea
        if (singletonGenesis == null) {
            singletonGenesis = new SingletonGenesis(context);
        }
        return singletonGenesis;
    }
